    ...
    >
      {items.map((c, i) => (
        <article
          ...
          onClick={() =>
            onCardClick ? onCardClick(c) : c.url && window.open(c.url, "_blank", "noopener,noreferrer")
          }
          style={{
        ...
        >
          <div className="chroma-img-wrapper">
            <img
              src={c.image}
              alt={c.title || c.caption || c.category || "item"}
              loading="lazy"
            />
          </div>
          <footer className="chroma-info">
            <h3 className="name">
              {c.title || c.caption || (c.category ? c.category.toUpperCase() : "Item")}
            </h3>
